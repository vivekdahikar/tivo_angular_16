...
//expense
export let expensechart: ChartOptions | any = {
  series: [
    {
      name: "Net Profit",
...
//status chart
export let statuschart: ChartOptions | any = {
  chart: {
    type: "radialBar",
    height: 375,
    offsetY: -30,
...
//live
export let liveproduct: ChartOptions | any = {
  series: [
    {
      name: "TEAM A",
      type: "area",
...
export const WidgetsUserChart: ChartOptions | any = {
  ...
  colors: [primary_color, secondary_color, "#61ae41", "#4faad5"],
  title: {
...
export const BrowserUses: ChartOptions | any = {
  ...
  plotOptions: {
    candlestick: {
      colors: { upward: primary_color, downward: secondary_color },
    },
  },
  colors: ["#fb740d"],
...
export let progress1: ChartOptions | any = {
  ...
  plotOptions: {
    bar: {
      ...
      barHeight: "20%",
      colors: {
        backgroundBarColors: ["rgba(92, 97, 242, 0.2)"],
      },
    },
  },
  colors: [primary_color],
...
export let progress2: ChartOptions | any = {
  ...
  plotOptions: {
    bar: {
      ...
      barHeight: "20%",
      colors: {
        backgroundBarColors: ["rgba(238, 184, 47, 0.2)"],
      },
    },
  },
  colors: ["#eeb82f"],
...
export let progress3: ChartOptions | any = {
  ...
  plotOptions: {
    bar: {
      ...
      barHeight: "20%",
      colors: {
        backgroundBarColors: ["rgba(97, 174, 65, 0.2)"],
      },
    },
  },
  colors: ["#61ae41"],
...
export let progress4: ChartOptions | any = {
  ...
  plotOptions: {
    bar: {
      ...
      barHeight: "20%",
      colors: {
        backgroundBarColors: ["rgba(79, 170, 213, 0.2)"],
      },
    },
  },
  colors: ["#4faad5"],
