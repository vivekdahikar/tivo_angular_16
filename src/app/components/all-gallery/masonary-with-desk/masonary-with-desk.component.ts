...
@Component({
  selector: 'app-masonary-with-desk',
  templateUrl: './masonary-with-desk.component.html',
  styleUrls: ['./masonary-with-desk.component.scss'],
})
export class MasonaryWithDeskComponent {
